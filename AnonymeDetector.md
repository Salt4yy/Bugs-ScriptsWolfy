...
2.  **Utiliser des IDs de Session :** Remplacer l'ID utilisateur permanent par un identifiant temporaire, unique à chaque partie, dans les URLs publiques comme celles des avatars. (actuellement implémentée depuis le patch du parfait ano du 14 février 2026)
